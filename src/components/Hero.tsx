    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="text-center">
          <p className="tracking-[0.3em] uppercase mb-0 text-center font-extrabold text-sm md:text-xl text-yellow-400 md:text-slate-200 mt-24 md:mt-0" style={{fontWeight: 800}}>Общестроительные работы · Производство и монтаж металлоконструкций · Малоэтажное строительство под ключ · Благоустройство</p>
