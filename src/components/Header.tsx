    ...
    >
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <button
            onClick={openLeadForm}
            className="inline-flex items-center justify-center text-sm px-5 py-2.5 border border-white/40 text-white hover:bg-white hover:text-foreground transition-all duration-300 mb-4 mr-3"
          >
            Бесплатный расчёт
          </button>
