...
const faqs = [
  {
    ...
    answer:
      "Работаем по всей России. Выезжаем на объекты в любой регион — стоимость и сроки доставки обсуждаются индивидуально. Большинство наших реализованных объектов находится в Центральном, Южном и Поволжском федеральных округах.",
  },
  {
